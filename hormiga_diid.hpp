...
class Hormiga_diid : public Hormiga {

  public:

    Hormiga_diid(std::pair<int,int> posicionHormiga, Direccion direccionMovimiento);
    Hormiga_diid(int posX, int posY, Direccion direccionMovimiento);
    ~Hormiga_diid();
